package com.peng.userservice.server.controller;
...
import com.peng.userservice.server.mapper.UserRepository;
import com.peng.userservice.server.service.UserServiceDetail;
...
public class UserServiceController implements UserService {
    ...
    public com.peng.userservice.dto.User postUser(@RequestParam("username") String username,
